exports.neo4j = if (process.env.production or process.env.staging) then 'http://10.252.79.119:7474/' else 'http://ec2-50-112-34-145.us-west-2.compute.amazonaws.com:7474/'
